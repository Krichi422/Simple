...
function SimpleData:__init(Simple)		
	...
	if RunService:IsStudio() then
		warn('>> Please customize Template module according to your preferences.')
	end
	
	if RunService:IsServer() then		
		log(">> Initializing Simple's data for players.")
		...
		log(">> Initialized Simple's data for players.'")
		
		log(">> Initializing Simple's data for other datastore instances.")
		...
		log(">> Initialized Simple's data for other datastore instances.")
	end
end
